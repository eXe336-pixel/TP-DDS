...
export default function RegistroLocalidad({
  AccionABMC,  
  Item,
  Grabar,
  Volver  
        ...
        <fieldset disabled={AccionABMC === "C"}>
          ...
          <div className="row">
            <div className="col-sm-4 col-md-3 offset-md-1">
              <label className="col-form-label" htmlFor="NombreLocalidad">
                Nombre Localidad<span className="text-danger">*</span>:
              </label>
            </div>
            <div className="col-sm-8 col-md-6">
              <input
                type="text"
                {...register("NombreLocalidad", {
                ...
                autoFocus
                className={
                  "form-control " + (errors?.NombreLocalidad ? "is-invalid" : "")
                }
              />
              {errors?.NombreLocalidad && touchedFields.Nombre && (
                <div className="invalid-feedback">
                  {errors?.NombreLocalidad?.message}
                </div>
              )}
            </div>
          </div>
            ...
            <div className="col-sm-8 col-md-6">
              <input
                ...
                {...register("FechaCreacion", {
                  required: { message: "Fecha Creacion es requerido" }
                })}
                className={
